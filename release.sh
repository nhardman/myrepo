...
git remote add origin https://nhardman:$GH_TOKEN@github.com/nhardman/myrepo
...
curl -u nhardman:$GH_TOKEN -X DELETE -H "Accept: application/vnd.github.loki-preview+json" "https://api.github.com/repos/nhardman/myrepo/branches/$BRANCH_TO_DELETE/protection"
