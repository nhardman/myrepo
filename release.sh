...
git remote add $GH_REMOTE https://$GH_USER:$GH_TOKEN@github.com/$GH_USER/$PROJECT
...
curl -u $GH_USER:$GH_TOKEN -X DELETE -H "Accept: application/vnd.github.loki-preview+json" "https://api.github.com/repos/$GH_USER/$PROJECT/branches/$BRANCH_TO_DELETE/protection"
